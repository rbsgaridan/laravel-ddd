...
class FlutterProxyGenerator
{
    ...
    {
        $flutterRoot = $this->resolvePath($options['flutter_root'] ?? PackageConfig::flutterRoot());
        $outputPath = $this->resolvePath($options['output'] ?? PackageConfig::flutterOutputPath());
        $configPath = $this->resolvePath($options['config'] ?? PackageConfig::flutterConfigPath());
        $jarPath = $this->resolvePath($options['jar'] ?? PackageConfig::flutterJarPath());
        $generator = (string) ($options['generator'] ?? PackageConfig::flutterGenerator());
